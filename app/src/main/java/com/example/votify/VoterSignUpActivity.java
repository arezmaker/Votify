...
public class VoterSignUpActivity extends AppCompatActivity {
    ...
    public void goToVoterLoginActivity(View view) {
        ...
        if (name.length()==0)
        {
            Toast.makeText(VoterSignUpActivity.this,"Invalid name",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            ...
            Toast.makeText(VoterSignUpActivity.this,"Invalid Date Format",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (years < 18)
        {
            Toast.makeText(VoterSignUpActivity.this,"Age less than 18",Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(cnic.length()==13)
        {
            ...
            {
                Toast.makeText(VoterSignUpActivity.this,"Invalid CNIC",Toast.LENGTH_SHORT).show();
                return;
            }
        }
        else
        ...
        if(address.length()==0)
        {
            Toast.makeText(VoterSignUpActivity.this,"Invalid address",Toast.LENGTH_SHORT).show();
            return;
        }
